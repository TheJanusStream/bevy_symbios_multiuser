...
| `relay` | No | Sovereign Broker relay with DID-based JWT signature verification, room isolation, atomic connection limits, SSRF-hardened DID resolution, message size caps, idle/handshake timeouts, and negative DID caching (`axum`/`tokio`/`p256`/`moka`) |
